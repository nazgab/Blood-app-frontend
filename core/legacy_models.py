...
class Donation(models.Model):
    ...
    user          = models.ForeignKey(LegacyUser, on_delete=models.DO_NOTHING,
                                      db_column="user_id", related_name="donations")
    center        = models.ForeignKey(Center, on_delete=models.DO_NOTHING,
                                      db_column="center_id", related_name="donations")
...
class Bonus(models.Model):
    ...
    user       = models.ForeignKey(LegacyUser, on_delete=models.DO_NOTHING,
                                   db_column="user_id", related_name="bonuses")
