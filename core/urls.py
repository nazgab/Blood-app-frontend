...
urlpatterns = [
    ...
    path("legacy/users/<int:user_id>/", lviews.LegacyUserDetailView.as_view(), name="legacy-user-detail"),
    path("legacy/centers/", lviews.CenterListView.as_view(), name="legacy-centers"),
    path("legacy/users/<int:user_id>/donations/", lviews.DonationListByUserView.as_view(), name="legacy-user-donations"),
